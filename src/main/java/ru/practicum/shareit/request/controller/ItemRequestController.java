...
public class ItemRequestController {
    ...
    public List<ItemRequestDTOWithAnswers> getUserRequests(@RequestHeader("X-Sharer-User-Id") @Positive long userId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ItemRequestDTOWithAnswers getRequestById(@RequestHeader("X-Sharer-User-Id") @Positive long userId,
